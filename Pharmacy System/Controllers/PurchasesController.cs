...
namespace Pharmacy_System.Controllers
{
    public class PurchasesController : Controller
    {
        ...
        public PurchasesController(RegisterDb context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PurchaseID,MedicineID,SupplierID,Quantity,PurchaseDate,CostPerUnit,TotalCost")] Purchases purchases)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PurchaseID,MedicineID,SupplierID,Quantity,PurchaseDate,CostPerUnit,TotalCost")] Purchases purchases)
        {
